               ...
               <tbody>
                 <tr>
                   ...
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault1">A. menonton televisi.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault2">B. berbincang-bincang dengan teman-teman.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault3">C. melakukan aktivitas fisik atau membuat sesuatu.</label>
                   </div></td>
                 </tr>
               </tbody>
             </table>
               ...
               <tbody>
                 <tr>
                   ...
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault4">A. mengatur pertemuan bersama.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault5">B. berbicara dengan mereka melalui telepon.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault6">C. mencoba melakukan sesuatu bersama-sama, misalnya suatu kegiatan atau makan bersama.</label>
                   </div></td>
                 </tr>
               </tbody>
             </table>
               ...
               <tbody>
                 <tr>
                   ...
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault7">A. tampilannya dan pakaiannya.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault8">B. suara dan cara berbicaranya.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault9">C. caranya berdiri dan bergerak.</label>
                   </div></td>
                 </tr>
               </tbody>
             </table>
               ...
               <tbody>
                 <tr>
                   ...
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault10">A. terus mengingat dan mencari tahu hal yang membuat saya marah</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault11">B. menyampaikan ke orang-orang sekitar tentang perasaan saya.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault12">C. membanting pintu atau menunjukkan kemarahan saya dengan cara lainnya.</label>
                   </div></td>
                 </tr>
               </tbody>
             </table>
               ...
               <tbody>
                 <tr>
                   ...
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault13">A. wajah.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault14">B. nama.</label>
                   </div></td>
                 </tr>
                 <tr>
                   <th scope="row"></th>
                   <td><div class="form-check">
                     ...
                     <label class="form-check-label" for="flexRadioDefault15">C. hal-hal yang telah saya lakukan.</label>
                   </div></td>
                 </tr>
               </tbody>
             </table>
